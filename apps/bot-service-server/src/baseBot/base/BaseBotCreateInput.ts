...
class BaseBotCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => BotCreateNestedManyWithoutBaseBotsInput,
  })
  @ValidateNested()
  @Type(() => BotCreateNestedManyWithoutBaseBotsInput)
  @IsOptional()
  @Field(() => BotCreateNestedManyWithoutBaseBotsInput, {
    nullable: true,
  })
...
export { BaseBotCreateInput as BaseBotCreateInput };
